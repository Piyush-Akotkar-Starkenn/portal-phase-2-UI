        ...
        <div className="card p-8">
          <Fieldset legend="Summary" className="pl-6">
            <div class="relative overflow-x-auto">
              <table class="w-[50vw] text-left text-sm text-gray-500 dark:text-gray-400">
                <tbody>
                  <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">Driver/ Vehicle Summary</td>
                  </tr>
                  <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <th
                      scope="row"
                    ...
                    <td class="px-6 py-4">10/ 07/ 2023 TO 23/ 07/ 2023</td>
                  </tr>
              ...
              <table class="w-[50vw] text-left text-sm text-gray-500 dark:text-gray-400">
                <tbody>
                  <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">Time (days/ hours)</td>
                  </tr>
                  <tr class="bg-white dark:bg-gray-800">
                    <th
                      scope="row"
